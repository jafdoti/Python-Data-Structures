...
print("The daily average temperature on Venus is {:.2f} Farenheit".format(venus_result))
print("The daily average temperature on Mars is {:.2f} Farenheit".format(mars_result))
