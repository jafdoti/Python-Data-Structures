...
"""
The keyword lambda is first, then the arguments to the function followed by a colon, 
and then you are allowed to have a single expression. 
So these are limited functions. They can't have multiple lines of code.
"""
